...
_DEVICETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="DEVICE_IOS_OS", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="DEVICE_CHROME_BROWSER",
            index=2,
            number=3,
            serialized_options=None,
            type=None,
...
_CHROMEBUILDPROTO_PLATFORM = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="PLATFORM_WIN", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLATFORM_MAC", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLATFORM_LINUX", index=2, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLATFORM_CROS", index=3, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PLATFORM_IOS", index=4, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_CHROMEBUILDPROTO_CHANNEL = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="CHANNEL_STABLE", index=0, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHANNEL_BETA", index=1, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHANNEL_DEV", index=2, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHANNEL_CANARY", index=3, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_CHROMEBUILDPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="chrome_version",
            full_name="checkin_proto.ChromeBuildProto.chrome_version",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_ANDROIDCHECKINPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="checkin_proto.AndroidCheckinProto.last_checkin_msec",
            index=0,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="cell_operator",
            full_name="checkin_proto.AndroidCheckinProto.cell_operator",
            index=1,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="sim_operator",
            full_name="checkin_proto.AndroidCheckinProto.sim_operator",
            index=2,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="roaming",
            full_name="checkin_proto.AndroidCheckinProto.roaming",
            index=3,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="user_number",
            full_name="checkin_proto.AndroidCheckinProto.user_number",
            index=4,
            number=9,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="checkin_proto.AndroidCheckinProto.type",
            index=5,
            number=12,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="chrome_build",
            full_name="checkin_proto.AndroidCheckinProto.chrome_build",
            index=6,
            number=13,
            type=11,
            cpp_type=10,
...
ChromeBuildProto = _reflection.GeneratedProtocolMessageType(
    "ChromeBuildProto",
    (_message.Message,),
    dict(
